About freediscovery-feedstock
=============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/freediscovery-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/FreeDiscovery/FreeDiscovery

Documentation: https://freediscovery.github.io/doc/stable/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5213&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/freediscovery-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `freediscovery` can be installed with `conda`:
...
```
mamba install freediscovery
```

It is possible to list all of the versions of `freediscovery` available on your platform with `conda`:
...
```
mamba search freediscovery --channel conda-forge
```
...
mamba repoquery search freediscovery --channel conda-forge

# List packages depending on `freediscovery`:
mamba repoquery whoneeds freediscovery --channel conda-forge

# List dependencies of `freediscovery`:
mamba repoquery depends freediscovery --channel conda-forge
```
